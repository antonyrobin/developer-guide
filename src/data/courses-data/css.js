...
p { color: red !important; }  /* Overrides everything — avoid */`,
    ...
    { title: 'Best Practices & Code Standards', content: `**BEM naming** (Block Element Modifier) is the industry standard for scalable CSS. Name classes as \`.block__element--modifier\` to make relationships clear and avoid specificity wars. Combine BEM with **CSS custom properties** for theming and maintainability.\n\n### Responsive Design\n\nAlways design **mobile-first** — start with the smallest screen and add complexity with \`min-width\` media queries. This produces cleaner CSS because mobile styles are the base, and larger screens add layout features.\n\n### Performance & Maintainability\n\nAvoid \`!important\` — it breaks the cascade and makes debugging painful. If you need \`!important\`, your specificity structure needs fixing. Keep selectors shallow (max 2-3 levels) and prefer classes over IDs for styling. Group related styles and use a consistent property order (positioning, box model, typography, visual).`, code: `/* DO: BEM naming convention */\n.card { }\n.card__title { }\n.card__body { }\n.card--featured { border: 2px solid gold; }\n\n/* DON'T: Unclear, fragile selectors */\n.c1 { }\ndiv > ul > li > a.link2 { }\n#header .nav .item { }\n\n/* DO: CSS custom properties for theming */\n:root {\n  --color-primary: #3b82f6;\n  --color-text: #1f2937;\n  --spacing-md: 1rem;\n  --radius-md: 0.5rem;\n}\n.btn-primary {\n  background: var(--color-primary);\n  padding: var(--spacing-md);\n  border-radius: var(--radius-md);\n}\n\n/* DO: Mobile-first responsive design */\n.grid { display: flex; flex-direction: column; gap: 1rem; }\n@media (min-width: 768px) {\n  .grid { flex-direction: row; }\n}\n\n/* DON'T: Desktop-first (harder to maintain) */\n.grid { display: flex; flex-direction: row; }\n@media (max-width: 768px) {\n  .grid { flex-direction: column; }\n}`, codeLabel: 'Dos & Don\'ts', keyPoints: ['Use BEM naming (block__element--modifier) for scalable CSS.', 'Design mobile-first with min-width media queries.', 'Use CSS custom properties instead of hardcoded values.', 'Avoid !important — fix specificity issues at the source.'] }
  ]
};
